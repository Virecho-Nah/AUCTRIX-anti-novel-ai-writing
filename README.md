...
- 新增“功能性细节链”保护：细节密集、动作分行或副词集中不等于 AI 味
- 压缩前必须区分误认、异常、揭示、苏醒、爆发、审视、锁定等独立功能
- 禁止把渐进揭示和观众发现过程压成直接剧情结论
- 增加“怪物眼睑苏醒并锁定角色”的过度清洗反例与正确处理示例
- 修复 `agents/openai.yaml` 的乱码，并在默认提示中明确保留功能性细节链
